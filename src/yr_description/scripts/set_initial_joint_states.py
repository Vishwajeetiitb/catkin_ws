...
if __name__ == "__main__":
    ...
    rospy.sleep(5)  # Wait a bit for everything to initialize
    ...
    # manager.set_angles({'yr_l_pel_joint': 0.0, 'yr_l_hip_joint': 0*-PI/4,'yr_l_kne_joint': 0*PI/2, 'yr_l_ank_joint': 0*-PI/4,'yr_r_pel_joint': 0.0, 'yr_r_hip_joint': 0*-PI/4,'yr_r_kne_joint': 0*PI/2, 'yr_r_ank_joint': 0*-PI/4})
    print('ended')
