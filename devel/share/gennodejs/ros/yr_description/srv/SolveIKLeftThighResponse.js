...
class SolveIKLeftThighResponseRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SolveIKLeftThighResponseRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SolveIKLeftThighResponseRequest
    let len;
    let data = new SolveIKLeftThighResponseRequest(null);
  ...
  static datatype() {
    ...
    return 'yr_description/SolveIKLeftThighResponseRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SolveIKLeftThighResponseRequest(null);
...
class SolveIKLeftThighResponseResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SolveIKLeftThighResponseResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SolveIKLeftThighResponseResponse
    let len;
    let data = new SolveIKLeftThighResponseResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SolveIKLeftThighResponseResponse(null);
...
module.exports = {
  Request: SolveIKLeftThighResponseRequest,
  Response: SolveIKLeftThighResponseResponse,
  md5sum() { return '05815670e17c3341d3dc434a6547e3b1'; },
  datatype() { return 'yr_description/SolveIKLeftThighResponse'; }
};
