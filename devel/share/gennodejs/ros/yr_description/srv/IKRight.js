...
class IKRightRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type IKRightRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type IKRightRequest
    let len;
    let data = new IKRightRequest(null);
  ...
  static datatype() {
    ...
    return 'yr_description/IKRightRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new IKRightRequest(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
class IKRightResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type IKRightResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type IKRightResponse
    let len;
    let data = new IKRightResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new IKRightResponse(null);
...
module.exports = {
  Request: IKRightRequest,
  Response: IKRightResponse,
  md5sum() { return '2d3149f50ac2299a08916bb78e0c6b8d'; },
  datatype() { return 'yr_description/IKRight'; }
};
