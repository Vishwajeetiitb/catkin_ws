...
class ComputeLeftFootPositionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ComputeLeftFootPositionRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ComputeLeftFootPositionRequest
    let len;
    let data = new ComputeLeftFootPositionRequest(null);
  ...
  static datatype() {
    ...
    return 'yr_description/ComputeLeftFootPositionRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ComputeLeftFootPositionRequest(null);
...
class ComputeLeftFootPositionResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ComputeLeftFootPositionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ComputeLeftFootPositionResponse
    let len;
    let data = new ComputeLeftFootPositionResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'yr_description/ComputeLeftFootPositionResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ComputeLeftFootPositionResponse(null);
...
module.exports = {
  Request: ComputeLeftFootPositionRequest,
  Response: ComputeLeftFootPositionResponse,
  md5sum() { return '05815670e17c3341d3dc434a6547e3b1'; },
  datatype() { return 'yr_description/ComputeLeftFootPosition'; }
};
