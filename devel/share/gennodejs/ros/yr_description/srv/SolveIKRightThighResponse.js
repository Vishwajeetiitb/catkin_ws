...
class SolveIKRightThighResponseRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SolveIKRightThighResponseRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SolveIKRightThighResponseRequest
    let len;
    let data = new SolveIKRightThighResponseRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SolveIKRightThighResponseRequest(null);
...
class SolveIKRightThighResponseResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SolveIKRightThighResponseResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SolveIKRightThighResponseResponse
    let len;
    let data = new SolveIKRightThighResponseResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'yr_description/SolveIKRightThighResponseResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SolveIKRightThighResponseResponse(null);
...
module.exports = {
  Request: SolveIKRightThighResponseRequest,
  Response: SolveIKRightThighResponseResponse,
  md5sum() { return '05815670e17c3341d3dc434a6547e3b1'; },
  datatype() { return 'yr_description/SolveIKRightThighResponse'; }
};
