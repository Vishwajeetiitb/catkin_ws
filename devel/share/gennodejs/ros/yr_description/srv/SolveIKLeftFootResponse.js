...
class SolveIKLeftFootResponseRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SolveIKLeftFootResponseRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SolveIKLeftFootResponseRequest
    let len;
    let data = new SolveIKLeftFootResponseRequest(null);
  ...
  static datatype() {
    ...
    return 'yr_description/SolveIKLeftFootResponseRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SolveIKLeftFootResponseRequest(null);
...
class SolveIKLeftFootResponseResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SolveIKLeftFootResponseResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SolveIKLeftFootResponseResponse
    let len;
    let data = new SolveIKLeftFootResponseResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'yr_description/SolveIKLeftFootResponseResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SolveIKLeftFootResponseResponse(null);
...
module.exports = {
  Request: SolveIKLeftFootResponseRequest,
  Response: SolveIKLeftFootResponseResponse,
  md5sum() { return '05815670e17c3341d3dc434a6547e3b1'; },
  datatype() { return 'yr_description/SolveIKLeftFootResponse'; }
};
