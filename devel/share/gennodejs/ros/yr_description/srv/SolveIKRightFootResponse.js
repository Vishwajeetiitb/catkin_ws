...
class SolveIKRightFootResponseRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SolveIKRightFootResponseRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SolveIKRightFootResponseRequest
    let len;
    let data = new SolveIKRightFootResponseRequest(null);
  ...
  static datatype() {
    ...
    return 'yr_description/SolveIKRightFootResponseRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SolveIKRightFootResponseRequest(null);
...
class SolveIKRightFootResponseResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SolveIKRightFootResponseResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SolveIKRightFootResponseResponse
    let len;
    let data = new SolveIKRightFootResponseResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'yr_description/SolveIKRightFootResponseResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SolveIKRightFootResponseResponse(null);
...
module.exports = {
  Request: SolveIKRightFootResponseRequest,
  Response: SolveIKRightFootResponseResponse,
  md5sum() { return '05815670e17c3341d3dc434a6547e3b1'; },
  datatype() { return 'yr_description/SolveIKRightFootResponse'; }
};
